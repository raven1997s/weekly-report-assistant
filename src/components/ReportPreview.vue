    ...
    <div class="preview-header">
      ...
      <div class="preview-toolbar">
        <div class="action-group primary">
          ...
          <button v-if="showDingtalkAction" class="btn btn-accent btn-sm" @click="showPreviewModal = true">
            <svg width="16" height="16" viewBox="0 0 20 20" fill="currentColor" style="vertical-align: middle; margin-right: 4px;">
        ...
        <div class="action-group secondary">
          <button v-if="showCopyTextAction" class="btn btn-secondary btn-sm" @click="copyText">
            <svg width="16" height="16" viewBox="0 0 20 20" fill="currentColor" style="vertical-align: middle; margin-right: 4px;">
              <path fill-rule="evenodd" d="M4 2a2 2 0 00-2 2v11a3 3 0 106 0V4a2 2 0 00-2-2H4zm1 14a1 1 0 100-2 1 1 0 000 2zm5-1.757l4.9-4.9a2 2 0 000-2.828L13.485 5.1a2 2 0 00-2.828 0L10 5.757v8.486zM16 18H9.071l6-6H16a2 2 0 012 2v2a2 2 0 01-2 2z" clip-rule="evenodd"/>
            </svg>
            复制纯文本
          </button>
          <button v-if="showDownloadAction" class="btn btn-secondary btn-sm" @click="download">
            <svg width="16" height="16" viewBox="0 0 20 20" fill="currentColor" style="vertical-align: middle; margin-right: 4px;">
          ...
          <button v-if="showMailDraftAction" class="btn btn-secondary btn-sm" @click="$emit('save-mail-draft')">
            <svg width="16" height="16" viewBox="0 0 20 20" fill="currentColor" style="vertical-align: middle; margin-right: 4px;">
...
import { getWorkMonthWeekLabel } from '../utils/date'
...
const previewTitle = computed(() => {
  ...
  if (!weekLabel) {
    if (props.report.weekStart) {
      weekLabel = getWorkMonthWeekLabel(new Date(props.report.weekStart))
    } else {
      weekLabel = getWorkMonthWeekLabel(new Date())
    }
  }
  return `周报 - ${weekLabel}`
})
